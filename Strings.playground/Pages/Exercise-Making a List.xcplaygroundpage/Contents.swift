 ...
 */
let spaceMaking = "Using \n in a statement will add a new line "
let combiningString = "We use + to combine strings into one"
let quotationMarks = "using quotation marks can create lines code that can be words which help when including into strings"
