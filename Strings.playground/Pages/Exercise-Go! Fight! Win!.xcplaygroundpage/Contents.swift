...
let schoolName = "John Hancock College prep"
let refrain = "Go school go \(schoolName) rocks go go go \(schoolName) you are not ready for our spirit  \(schoolName) is unstoppable "

let song = "A loving community here\n \(refrain)\n\(refrain)\nYes,We love to hear you cheer \(refrain)"
